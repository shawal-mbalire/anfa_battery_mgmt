...
/* USER CODE BEGIN PV */
uint16_t adc_buffer[ADC_NUM_CONVERSIONS]; // buffer to store ADC values
/* USER CODE END PV */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
  HAL_ADCEx_Calibration_GetValue(&hadc1); // caibrate the ADC
  HAL_ADC_Start_DMA(&hadc1, (uint32_t*)adc_buffer, ADC_NUM_CONVERSIONS); // start ADC in DMA mode to fill buffer 10 times a second
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, RS485_DRIVER_ENABLE_Pin|PWM_LED_CURRENT_1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : RS485_RECEIVER_ENABLE_Pin */
  GPIO_InitStruct.Pin = RS485_RECEIVER_ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(RS485_RECEIVER_ENABLE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : RS485_DRIVER_ENABLE_Pin PWM_LED_CURRENT_1_Pin */
  GPIO_InitStruct.Pin = RS485_DRIVER_ENABLE_Pin|PWM_LED_CURRENT_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : BMS_INTERRUPT_Pin */
  GPIO_InitStruct.Pin = BMS_INTERRUPT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(BMS_INTERRUPT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : PWR_GOOD_VBAT_OUT_Pin MPPT_BQ_INTERRUPT_Pin */
  GPIO_InitStruct.Pin = PWR_GOOD_VBAT_OUT_Pin|MPPT_BQ_INTERRUPT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : FLAG_USB_100W_Pin PD10 FLAG_USB_60W_Pin */
  GPIO_InitStruct.Pin = FLAG_USB_100W_Pin|GPIO_PIN_10|FLAG_USB_60W_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
