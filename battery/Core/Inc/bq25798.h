...
#include "stm32g0xx_hal_conf.h" /* needed for I2C */

/* Defines */
/* --- I2C Configuration --- */
/**
 * @brief The 7-bit I2C slave address of the BQ25798.
 * This address must be left-shifted by one bit to include the R/W bit.
 */
#define BQ25798_I2C_ADDRESS_7BIT      (0x6B) // page 53
#define BQ25798_I2C_ADDRESS           (BQ25798_I2C_ADDRESS_7BIT << 1) // 7 bit  left shifted by one
...
uint8_t BQ25798_init(I2C_HandleTypeDef *i2cHandle);

// DATA ACQUISATION


// LOW LEVEL FUNCTIONS
HAL_StatusTypeDef BQ25798_ReadRegister (uint8_t reg, uint8_t *data);
HAL_StatusTypeDef BQ25798_ReadRegisters(uint8_t reg, uint8_t *data, uint8_t length);
HAL_StatusTypeDef BQ25798_WriteRegister(uint8_t reg, uint8_t *data);
