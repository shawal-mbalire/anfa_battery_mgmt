...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB12     ------> ADC1_IN16
    */
    HAL_GPIO_DeInit(GPIOA, ADC_LED_VOLTAGE_4_Pin|ADC_LED_VOLTAGE_3_Pin|ADC_LED_VOLTAGE_2_Pin|ADC_LED_VOLTAGE_1_Pin
                          |ADC_BATTERY_NTC_2_Pin|ADC_SYS_CURRENT_Pin);

    HAL_GPIO_DeInit(GPIOC, DC_USB_C_60W_I_SENSE_Pin|DC_USB_C_60W_V_SINK_Pin);

    HAL_GPIO_DeInit(GPIOB, ADC_USB_C_60W_IN_Pin|ADC_USB_C_100W_V_BUS_Pin|ADC_USB_C_100W_V_SOURCE_Pin|ADC_USB_C_100W_V_SINK_Pin
                          |ADC_USB_C_60W_V_BUS_Pin);
